            ...
            parser.parse(line)
                  .ifPresent(message -> {
                      ...
                      if (!target_paths.isEmpty()) {
                          ...
                          targetPathsMap.put(new SourceUuid_Timestamp(sourceUuid, timestamp), target_paths);
                      }
                      ...
                      if (reaction != null) {
                          ...
                          if (reactionHandlerMap.containsKey(emoji)) {
                              SourceUuid_Timestamp lookupKey = new SourceUuid_Timestamp(reaction.getTargetAuthorUuid(),
